...
def icmp_monitor_simple(timeout=1):
    ...
    while True:
        ...
        time.sleep(0.2)  # Tunggu sebelum iterasi berikutnya
...
def cost_calculation(th_link, ecn_mark, rtt_link, link_status):
    ...
    if th_link == 0:
        ...
        max_throughput = (BW_DEFAULT * WIDE_SCALE)/1000000  # Menghitung throughput maksimum dalam Bps
    ...
    if cost == 0:
        cost = 1000000  # Jika biaya adalah 0, set ke nilai maksimum (255555)
    else:
        cost = cost
