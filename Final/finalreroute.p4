    ...
    apply {
        ...
        if(hdr.ipv4.isValid()){
            ...
            //rtt calculation
                ...
                if(hdr.icmp.icmp_type == 8 || hdr.tcp.flags == 2 || hdr.tcp.flags == 24){
                    if (var_time1 == 0){
                ...
                }else if((hdr.icmp.icmp_type == 0 || hdr.tcp.flags == 20 || hdr.tcp.flags == 18 || hdr.tcp.flags == 16) && (var_time1 != 0) && (var_hash_out == var_hash_in)){
                    var_time2 = standard_metadata.ingress_global_timestamp;
                    meta.var_rtt = var_time2 - var_time1;
                    var_time1 = 0;
                    var_packetstatus = 0;
